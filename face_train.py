...
class Model:
    ...
    # 训练模型
    def train(self, dataset, batch_size=20, nb_epoch=80,data_augmentation=True):
    ...
    def face_predict(self, image):
        ...
        # 返回类别预测结果
        maxa=result_probability[0].argmax()
        
        return max(result_probability[0]),maxa
